...
<c:otherwise>
<form:form action="${pageContext.request.contextPath}/reset" class="register_form" modelAttribute="resetpassword" method = "post">
	<table>
		<tr>
			<td><label id="label" for="password">Password: </label></td>
			<td><form:input id="input" name = "password" path="password" required="true"/></td>
		</tr>
		<tr><td colspan="2"><button>Reset Password</button></td></tr>
	</table>
